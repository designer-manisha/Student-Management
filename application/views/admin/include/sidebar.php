    ...
    <div class="sidebar_wrapper" style="overflow: auto;">
        ...
        <div class="sidebar_list">
            ...
            <div class="sidebar_item">
                ...
                <?php $assignmentOpen = ($current == 'AssignSubjectController/index' || $current == 'AssignSubjectController/view_assignments' || $current == 'AssignSubjectController/classWiseSubjects' || $current == 'AssignSubjectController/filter_by_teacher_view' || $current == 'AssignSubjectController/filterByTeacher') ? 'show' : ''; ?>
                <div class="collapse <?php echo $assignmentOpen; ?>" id="assignmentSubmenu">
                    <div class="ps-4">
                        ...
                        <a href="<?php echo site_url('AssignSubjectController/filter_by_teacher_view'); ?>" class="sidebar_link <?php echo ($current == 'AssignSubjectController/filter_by_teacher_view' || $current == 'AssignSubjectController/filterByTeacher') ? 'active' : ''; ?>" style="color: #fff;">
