...
class Student extends CI_Controller
{
    ...
    // public function download_student_pdf($user_id = null)
    // {
    ...
    //     // If no user ID is passed, fallback to logged-in user
    //     if ($user_id === null) {
    ...
    //     $pdf->Cell(50, 10, 'ID:', 1);
    //     $pdf->Cell(140, 10, $user['id'], 1, 1);

    //     $pdf->Cell(50, 10, 'Name:', 1);
    //     $pdf->Cell(140, 10, $user['name'], 1, 1);
    //     $pdf->Cell(50, 10, 'Email:', 1);
    //     $pdf->Cell(140, 10, $user['email'], 1, 1);
    //     $pdf->Cell(50, 10, 'Phone:', 1);
    //     $pdf->Cell(140, 10, $user['phone'], 1, 1);
    //     $pdf->Cell(50, 10, 'Gender:', 1);
    //     $pdf->Cell(140, 10, $user['gender'], 1, 1);

    //     $pdf->Cell(50, 10, 'Created At:', 1);
    //     $pdf->Cell(140, 10, $user['created_at'], 1, 1);

    //     $pdf->Output('D', 'user_' . $user['id'] . '_details.pdf');
    // }
